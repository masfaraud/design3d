...
pt1, pt2, pt3, pt4 = (
    d3d.Point2D((offset_theta, offset_phi)),
    d3d.Point2D((offset_theta, offset_phi + phi)),
    d3d.Point2D((offset_theta + theta, offset_phi + phi)),
    d3d.Point2D((offset_theta + theta, offset_phi)),
)
seg1, seg2, seg3, seg4 = (
    d3d.LineSegment2D(pt1, pt2),
    d3d.LineSegment2D(pt2, pt3),
    d3d.LineSegment2D(pt3, pt4),
    d3d.LineSegment2D(pt4, pt1),
)
