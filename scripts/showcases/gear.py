...
profile_straight = primitives3D.ExtrudedProfile(po, xp, yp, c1, [c2], (0, 0, e), name="straight")
#
# model_straight=d3d.VolumeModel([profile_straight])

profile_helical = primitives3D.HelicalExtrudedProfile(
    po, xp, yp, d3d.Vector3D((0, 0, 0)), d3d.Vector3D((0, 0, e)), 28 * 3.14 / 180, c1, [c2], name="helical"
)
