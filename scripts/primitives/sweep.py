...
w = open_rounded_line_segements.primitives[0].unit_direction_vector(0.0)
u = open_rounded_line_segements.primitives[0].unit_normal_vector(0.0)
if not u:
