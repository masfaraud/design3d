...
box = primitives3d.Block(
    d3d.Frame3D(d3d.Point3D(0, 0, 0), d3d.Vector3D(0.3, 0, 0), d3d.Vector3D(0, 0.3, 0), d3d.Vector3D(0, 0, 0.3)),
    alpha=0.6,
)
...
box_green = box.frame_mapping(
    d3d.Frame3D(d3d.Point3D(0, 0.8, 0), d3d.Vector3D(1, 0, 0), d3d.Vector3D(0, 1, 0), d3d.Vector3D(0, 0, 1)), "new"
)
...
box_blue = box.frame_mapping(
    d3d.Frame3D(d3d.Point3D(0, 0.2, 0), d3d.Vector3D(1, 0, 0), d3d.Vector3D(0, 1, 0), d3d.Vector3D(0, 0, 1)), "old"
)
...
orange_box = box.frame_mapping(
    d3d.Frame3D(d3d.Point3D(0, 0.1, 0.2), d3d.Vector3D(1.5, 0, 0), d3d.Vector3D(0, 2, 0), d3d.Vector3D(0, 0, 0.5)),
    "old",
)
...
box_red = primitives3d.Block(
    d3d.Frame3D(d3d.Point3D(0, 0, 0), d3d.Vector3D(0.1, 0, 0), d3d.Vector3D(0, 0.1, 0), d3d.Vector3D(0, 0, 0.1)),
    color=(0.2, 1, 0.4),
    alpha=0.6,
)
