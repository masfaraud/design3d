...
from design3d.primitives2d import ClosedRoundedLineSegments2D, OpenedRoundedLineSegments2D
from design3d.primitives3d import RevolvedProfile

p1 = d3d.Point2D(-0.08, 0.1755)
p2 = d3d.Point2D(0.0, 0.1755)
p3 = d3d.Point2D(0.0, 0.04)
p4 = d3d.Point2D(0.01, 0.04)
p5 = d3d.Point2D(0.01, 0.0)
...
pbi2 = d3d.Point2D(-B / 2.0, d1 / 2.0)
pbi1 = pbi2.translation(d3d.Vector2D(h, 0))
pbi3 = d3d.Point2D(-B / 2.0, d / 2.0)
pbi4 = d3d.Point2D(B / 2.0, d / 2.0)
pbi5 = d3d.Point2D(B / 2.0, d1 / 2.0)
pbi6 = pbi5.translation(d3d.Vector2D(-h, 0))
bi1 = OpenedRoundedLineSegments2D(
    [pbi6, pbi5, pbi4, pbi3, pbi2, pbi1], {1: radius, 2: radius, 3: radius, 4: radius}, adapt_radius=True
)
...
profile5 = RevolvedProfile(frame2, c5, 0.15 * d3d.Y3D.to_point(), d3d.X3D, angle=0.7, name="strange part")
...
rim_contour = d3dw.ClosedPolygon2D(
    [
        d3d.Point2D(-0.5 * w, Rb),
...
conical_rim = RevolvedProfile(frame2, rim_contour, 0.5 * d3d.X3D.to_point(), d3d.X3D, angle=3.14, name="conical rim")
