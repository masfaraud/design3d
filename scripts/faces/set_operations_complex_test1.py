...
#
faces = [vmf.Triangle3D(*points)
          for points in poly1_vol1.sewing(poly2_vol1, vm.X3D, vm.Y3D)] + \
        [vmf.Triangle3D(*points)
         for points in poly2_vol1.sewing(poly3_vol1, vm.X3D, vm.Y3D)]
...
faces_2 = [vmf.Triangle3D(*points)
           for points in poly1_vol2.sewing(poly2_vol2, vm.X3D, vm.Z3D)] + \
          [vmf.Triangle3D(*points)
           for points in poly2_vol2.sewing(poly3_vol2, vm.X3D, vm.Z3D)] + \
          [vmf.Triangle3D(*points)
           for points in poly3_vol2.sewing(poly4_vol2, vm.X3D, vm.Z3D)] + \
          [vmf.Triangle3D(*points)
           for points in poly4_vol2.sewing(poly5_vol2, vm.X3D, vm.Z3D)]
