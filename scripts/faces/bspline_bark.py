...
base_points1 = [d3d.Point2D(0, 0), d3d.Point2D(0.1, 0.05), d3d.Point2D(0.2, 0.1), d3d.Point2D(0.2, 0.3)]
...
base_points2 = [d3d.Point2D(0, 0), d3d.Point2D(-0.1, 0.05), d3d.Point2D(-0.2, 0.13), d3d.Point2D(-0.2, 0.25)]
