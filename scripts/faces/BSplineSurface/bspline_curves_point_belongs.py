...
degree = 2
control_points = [
    d3d.Point2D(0.0, 0.10000000000000002),
...
# Bspline_curve
bspline_curve2d = d3de.BSplineCurve2D(degree, control_points, knot_multiplicities, knots)


# %% Point-belongs

points2d = [
    d3d.Point2D(0.18337173875665347, 0.29040613195152876),
    d3d.Point2D(0.4, 0.5),
    d3d.Point2D(0.5, 0.9),
