...
poly_1 = wires.ClosedPolygon3D(
    [
        d3d.Point3D(-0.3, 0.05, -0.20),
...
faces1 = (
    [faces.Triangle3D(*points) for points in new_poly_11.sewing(new_poly_12, d3d.X3D, d3d.Y3D)]
    + [faces.Triangle3D(*points) for points in new_poly_12.sewing(new_poly_13, d3d.X3D, d3d.Y3D)]
    + [faces.Triangle3D(*points) for points in new_poly_13.sewing(new_poly_14, d3d.X3D, d3d.Y3D)]
)
...
faces2 = (
    [faces.Triangle3D(*points) for points in new_poly_21.sewing(new_poly_22, d3d.X3D, d3d.Z3D)]
    + [faces.Triangle3D(*points) for points in new_poly_23.sewing(new_poly_22, d3d.X3D, d3d.Z3D)]
    + [faces.Triangle3D(*points) for points in new_poly_23.sewing(new_poly_24, d3d.X3D, d3d.Z3D)]
)
