...
box_green = box_red.frame_mapping(d3d.Frame3D(d3d.Point3D(-0.4, 0, -0.1), d3d.Vector3D(1, 0, 0),
...
shell1.alpha = 0.6
d3d.core.VolumeModel([shell1]).babylonjs()

box_blue = primitives3D.Block(
    d3d.Frame3D(d3d.Point3D(0.1, 0, 0), d3d.Vector3D(0.2, 0, 0),
               d3d.Vector3D(0, 0.1, 0), d3d.Vector3D(0, 0, 1)),
    alpha=0.6)
box_blue.color = (0.1, 0.1, 1)
box_blue.name = 'box_blue'

box_blue2 = box_blue.frame_mapping(d3d.Frame3D(d3d.Point3D(0.2, 0, 0), d3d.Vector3D(1, 0, 0),
                                              d3d.Vector3D(0, 1.8, 0), d3d.Vector3D(0, 0, 1)), 'old')
...
shell2.alpha = 0.6
d3d.core.VolumeModel([shell2]).babylonjs()
...
block1 = primitives3D.Block(frame=d3d.Frame3D(origin=d3d.Point3D(0.2, 0.6, 0.2),
                                             u=d3d.Point3D(0.4, 0, 0),
                                             v=d3d.Point3D(0, 1.2, 0),
                                             w=d3d.Point3D(0, 0, 0.4)),
                            color=(1, 0.2, 0.1), alpha=0.6)
block2 = primitives3D.Block(frame=d3d.Frame3D(origin=d3d.Point3D(0.8 + 0.4, 0.45 + 0.15, 0.1),
                                             u=d3d.Point3D(1.6, 0, 0),
                                             v=d3d.Point3D(0, 0.9, 0),
                                             w=d3d.Point3D(0, 0, 0.2)),
                            color=(0.2, 0.2, 0.2), alpha=0.6)

block3 = primitives3D.Block(frame=d3d.Frame3D(origin=d3d.Point3D(0.8 + 0.4, 0.45 + 0.15, 0.05),
                                             u=d3d.Point3D(1.6, 0, 0),
                                             v=d3d.Point3D(0, 0.9, 0),
                                             w=d3d.Point3D(0, 0, 0.2)),
                            color=(0.2, 0.2, 0.2), alpha=0.6)
