...
# p1 = d3d.Point2D((0, 0))
# p11 = d3d.Point2D((0.5, 0))
# p2 = d3d.Point2D((1, 0))
# p3 = d3d.Point2D((1, 1))
# p4 = d3d.Point2D((2.1, 3.23))
# p5 = d3d.Point2D((0, 1.23))
# p4 = d3d.Point2D((0,1))
# p5 = d3d.Point2D((0,2))

p0 = d3d.Point2D(0.2, -0.5)

p1 = d3d.Point2D(0, 0)
p2 = d3d.Point2D(0.5, 0)
p3 = d3d.Point2D(1, 0)
p4 = d3d.Point2D(1.5, 0)

p5 = d3d.Point2D(2, 0.4)
p6 = d3d.Point2D(2.5, 0.4)
p7 = d3d.Point2D(3, 0.4)
p8 = d3d.Point2D(3.5, 0.2)
...
cut_line = curves.Line2D(com, com + d3d.Point2D.random(-1, 1, 0, 1))
ax3 = rl2D_c2.plot()
...
u1 = cut_line.point_projection(list_centers_of_mass[0])[0] - list_centers_of_mass[0]
u1 = u1.unit_vector()
sign = -1
...
# p2 = d3d.Point3D((1, 0, 0))
# p3 = d3d.Point3D((1, 1, 1.2))
# p4 = d3d.Point3D((2.1, 3.23, 0.3))
# p5 = d3d.Point3D((0, 1.23,4.6))
#
#
