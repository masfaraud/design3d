...
primitives = [
    edges.LineSegment2D(volmdlr.Point2D(0.001, 0.014), volmdlr.Point2D(0.001, 0.0125)),
    ...
    edges.LineSegment2D(volmdlr.Point2D(-0.001, 0.0125), volmdlr.Point2D(-0.001, 0.014)),
    edges.LineSegment2D(volmdlr.Point2D(-0.001, 0.014), volmdlr.Point2D(0.001, 0.014)),
]
...
invalid_unordered_contour2_unittest = wires.Contour2D(
    [
        ...
        line_segment3,
        line_segment4,
        edges.LineSegment2D(volmdlr.Point2D(1, -1), volmdlr.Point2D(1.5, -1)),
    ]
)

unordered_wire_unittest = wires.Wire2D([line_segment2, bspline.reverse(), arc.reverse(), line_segment1, line_segment3])
