...
class TestClosedPolygon3D(unittest.TestCase):
    ...
    def circular_polygon(
        self,
        mean_radius: float,
        delta_radius,
        expected_number_points: int,
        x: design3d.Vector3D,
        y: design3d.Vector3D,
        theta0: float = 0.0,
    ):
    ...
    def test_sewing(self):
        ...
        poly1_normal_out = 0.0
        poly2_normal_out = 0.0
        ...
        self.assertGreater(poly1_normal_out / poly2_normal_out, 0.0)

        # Normals should point on the outside
        self.assertGreater(poly1_normal_out, 0.0)
        self.assertGreater(poly2_normal_out, 0.0)
