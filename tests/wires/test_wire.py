"""
Unit tests for design3d.wires.Wire
"""
...
class TestWire(unittest.TestCase):
    ...
    def test_from_edge(self):
        lns2d = edges.LineSegment2D(design3d.Point2D(0.2, 0.1), design3d.Point2D(0.5, 0.8))
        wire = wires.Wire2D.from_edge(lns2d, 2)
        self.assertAlmostEqual(len(wire.primitives), 2)

    def test_wires_from_edges(self):
        primitives = [
            edges.LineSegment2D(design3d.Point2D(-0.2, -0.2), design3d.Point2D(0.2, -0.2)),
            edges.LineSegment2D(design3d.Point2D(-0.1, 0.6), design3d.Point2D(-0.1, 0.2)),
            edges.LineSegment2D(design3d.Point2D(0.2, -0.2), design3d.Point2D(0.2, 0.2)),
            edges.LineSegment2D(design3d.Point2D(0.3, 0.2), design3d.Point2D(0.3, 0.6)),
            edges.LineSegment2D(design3d.Point2D(-0.2, 0.2), design3d.Point2D(-0.2, -0.2)),
            edges.LineSegment2D(design3d.Point2D(0.3, 0.6), design3d.Point2D(-0.1, 0.6)),
        ]
