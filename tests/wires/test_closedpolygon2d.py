...
class TestClosedPolygon2D(unittest.TestCase):
    ...
    def test_point_belongs(self):
        ...
        polygon = d3dw.ClosedPolygon2D(
            [
                design3d.Point2D(0, 0),
                design3d.Point2D(1, 2),
                design3d.Point2D(3, 0),
        ...
        edge_points = [
            design3d.Point2D(0, 0),
            design3d.Point2D(0.5, 1),
            design3d.Point2D(1, 2),
            design3d.Point2D(2, 1),
            design3d.Point2D(3, 0),
            design3d.Point2D(2.5, -1),
            design3d.Point2D(2, -2),
            design3d.Point2D(1, -1.5),
            design3d.Point2D(0, -1),
            design3d.Point2D(0, -0.5),
        ]
        ...
        polygon = d3dw.ClosedPolygon2D(
            [
                design3d.Point2D(0.025066533673536538, 0.0257663365438965),
