...
unordered_contour2_unittest = Contour2D([line_segment2, bspline.reverse(), arc.reverse(),
                                                          line_segment1, line_segment3, line_segment4])

invalid_unordered_contour2_unittest = Contour2D([line_segment2, bspline.reverse(), arc.reverse(),
                                                       line_segment1, line_segment3, line_segment4,
                                                       edges.LineSegment2D(design3d.Point2D(1, -1),
                                                                           design3d.Point2D(1.5, -1))])

unordered_wire_unittest = Wire2D([line_segment2, bspline.reverse(), arc.reverse(),
