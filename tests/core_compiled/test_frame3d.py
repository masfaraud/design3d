...
class TestFrame3D(unittest.TestCase):
    ...
    def test_from_step(self):
        ...
        arguments = [" ", 43, 44, 45]
        object_dict = {
            43: design3d.Point3D(-5.829000000001e0, -9.909144910505e-1, 8.766383164265e-1),
            44: design3d.Vector3D(0.0e0, 6.625993710787e-1, 7.489740138657e-1),
        ...
        arguments = [" ", 20, 21, "$"]
        object_dict = {20: design3d.O3D, 21: design3d.Y3D}
        frame = design3d.Frame3D.from_step(arguments, object_dict)
