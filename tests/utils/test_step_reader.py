import unittest
import design3d
from design3d.curves import Line3D
from design3d.utils import step_reader


class TestStepReader(unittest.TestCase):
    def test_trimmed_curve(self):
        point1 = design3d.Point3D(2.2, -1.0, 0.05)
        point2 = design3d.Point3D(2.201, -1.0, 0.05)
        ...
        point2 = design3d.Point3D(2.201, -1.0, 0.05)
        object_dict = {
            326: Line3D(point1, point2),
            327: design3d.Point3D(0.0, -1.0, 0.05),
            328: design3d.Point3D(1.0, -1.0, 0.05),
        }
