...
class TestFullArcEllipse3D(unittest.TestCase):
    start_end = design3d.Point3D(0.0225, 0.0, 0.0)
    major_axis = 0.0225
    minor_axis = 0.0075
    ...
    def test_translation(self):
        translated_ellipse = self.ellipse.translation(design3d.X3D)
        self.assertEqual(translated_ellipse.ellipse.center, design3d.Point3D(1, 0, 0))
