...
dict_bspline = {
    ...
    'weights': None,
    'periodic': False,
    'start': {'object_class': 'design3d.Point2D',
     'x': -0.4544751134860842,
     'y': 1.5707977686871983,
     'name': ''},
    'end': {'object_class': 'design3d.Point2D',
     'x': -0.3124009292097013,
     'y': -3.141592653588988,
     'name': ''},
    'control_points': [{'$ref': '#/start'},
     {'object_class': 'design3d.Point2D',
...
class TestBSplineCurve2D(unittest.TestCase):
    ...
    def test_interpolate_curve(self):
        ...
        points = [design3d.Point2D(0, 0), design3d.Point2D(3, 4), design3d.Point2D(-1, 4),
                  design3d.Point2D(-4, 0), design3d.Point2D(-4, -3)]
    ...
    def test_approximate_curve(self):
        ...
        points2d = [design3d.Point2D(0, 0.1),
    ...
    def test_discretization_points(self):
        control_points_2d = [design3d.Point2D(1.5707963267948966, 2.3),
        ...
        expected_points = [design3d.Point3D(0.0, 0.0, 0.0),
    ...
    def test_local_discretization(self):
        expected_points = [design3d.Point2D(0.22902909156524637, 0.17924444819399216),
