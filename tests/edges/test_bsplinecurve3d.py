...
class TestBSplineCurve3D(unittest.TestCase):
    b_splinecurve3d = vme.BSplineCurve3D(degree=5, control_points=[
        ...
        design3d.Point3D(0.5334, 1.13611540546, -1.95904362568), design3d.Point3D(0.5334, 1.49286052971, -1.64044168585),
        design3d.Point3D(0.5334, 1.64654439419, -1.45604332404), design3d.Point3D(0.5334, 1.77109261028, -1.25188280667),
        design3d.Point3D(0.5334, 1.86385510975, -1.03417888209)], knot_multiplicities=[6, 3, 6],
    ...
    def test_bounding_box(self):
        bspline = vme.BSplineCurve3D.from_points_interpolation([
            ...
            design3d.Point3D(-1.0, -1.0, 0.0)], 2, centripetal=True)
    ...
    def test_line_intersections(self):
        line = curves.Line3D(design3d.Point3D(0.5334, -0.44659009801843536, 0.0),
    ...
    def test_move_frame_along(self):
        ...
        self.assertEqual(bspline_curve3d.move_frame_along(frame),
                         design3d.Frame3D(origin=design3d.Point3D(-0.3, 0.4, 0.1),
                                         u=design3d.Vector3D(0.9632101019095523, 0.22376214189648538,
                                                            0.14885161548766362),
                                         v=design3d.Vector3D(2.7755575615628914e-17, 0.553867484333956,
                                                            -0.8326048341185484),
                                         w=design3d.Vector3D(-0.26874951084493176, 0.8019733871217126,
                                                            0.5334907560296971)))
