...
class TestArcEllipse3D(unittest.TestCase):
    ...
    def test_discretization_points(self):
        ...
        expected_points = [
            design3d.Point3D(0.029550000005800003, 0.0, 0.003949999999400002),
        ...
        arc_ellipse3d_2 = edges.ArcEllipse3D(
            curves.Ellipse3D(
                0.005586143570525195,
                0.0039499999993999994,
                design3d.Frame3D(design3d.Point3D(0.0335000000052, 0.0, 0.0), vec1, vec2, vec3),
            ),
    ...
    def test_complementary(self):
        ...
        self.assertAlmostEqual(
            self.arc_ellipse3d.length() + arc_ellipse3d_complementary.length(), self.arc_ellipse3d.ellipse.length()
        )
    ...
    def test_point_belongs(self):
        ...
        self.assertFalse(
            self.arc_ellipse3d.point_belongs(
    ...
    def test_translation(self):
        ...
        self.assertTrue(
            translated_arc_ellipse3d.start.is_close(
                design3d.Point3D(0.2391463117381003, 1.8122784967090868, 0.39806493433599155)
            )
        )
        self.assertTrue(
            translated_arc_ellipse3d.end.is_close(
    ...
    def test_frame_mapping(self):
        ...
        self.assertTrue(
            frame_mapped_arc_ellipse3d.start.is_close(design3d.Point3D(1.414213562373095, -0.7071067811865475, 0.0))
        )
        self.assertTrue(
            frame_mapped_arc_ellipse3d.end.is_close(design3d.Point3D(-1.414213562373095, -0.7071067811865475, 0.0))
        )
    ...
    def test_direction_vector(self):
        ...
        self.assertTrue(
            direction_vector.is_close(design3d.Point3D(0.36933737285964724, 0.6813567173546152, 0.6813567173546152))
        )

    def test_normal_vector(self):
        normal_vector = self.arc_ellipse3d.normal_vector(self.arc_ellipse3d.abscissa(self.discretization_points[2]))
        self.assertTrue(
    ...
    def test_linesegment_intersections(self):
        ...
        lineseg3 = edges.LineSegment3D(design3d.Point3D(3.0, 4.0, 2.5), design3d.Point3D(-3.0, -5.0, -2.0))
        expected_results = [
            [
    ...
    def test_arc_intersections(self):
        ...
        expected_intersections1 = [
            design3d.Point3D(1.354577913713, 0.964620364538, 0.964620364538),
        ...
        expected_intersections2 = [
            design3d.Point3D(1.3938468501173522, 0.5278214463329128, 0.5278214463329132),
    ...
    def test_arcellipse(self):
        ...
        self.assertTrue(
            arcellipse_intersections[0].is_close(design3d.Point3D(0.442026341769, -0.728884874076, -0.728884874076))
        )
