...
class TestArc3D(unittest.TestCase):
    ...
    def test_from_3_points(self):
        points = [design3d.Point3D(-0.2672612419124244, -0.5345224838248488, -0.8017837257372732),
    ...
    def test_direction_vector(self):
        ...
        self.assertTrue(direction_vector.is_close(
            design3d.Vector3D(-0.5773502691896258, -0.5773502691896258, -0.5773502691896258)))

    def test_normal_vector(self):
        normal_vector = self.arc3d.normal_vector(self.arc3d.abscissa(self.list_points[2]))
        self.assertTrue(normal_vector.is_close(
            design3d.Vector3D(-0.8164965809277261, 0.408248290463863, 0.408248290463863)))
    ...
    def test_rotation(self):
        ...
        self.assertTrue(rotated_arc3d.end.is_close(
            design3d.Point3D(-0.5773502691896253, 0.7886751345948129, -0.21132486540518736)))
    ...
    def test_frame_mapping(self):
        ...
        self.assertTrue(frame_mapped_arc3d.start.is_close(
            design3d.Point3D(0.9999999999999998, 0.0, 0.0)))
        self.assertTrue(frame_mapped_arc3d.end.is_close(
            design3d.Point3D(-0.7071067811865477, -0.7071067811865472, 0.0)))

    def test_to_2d(self):
        arc2d = self.arc3d.to_2d(self.arc3d.circle.center, self.arc3d.circle.frame.u, self.arc3d.circle.frame.v)
        self.assertTrue(arc2d.start.is_close(design3d.Point2D(1., 0.0)))
    ...
    def test_minimum_distance_points_arc(self):
        ...
        self.assertTrue(minimum_distance_points_arc[0].is_close(
            design3d.Point3D(0.5773502691896258, 0.5773502691896258, 0.5773502691896258)) or
        ...
        self.assertTrue(minimum_distance_points_arc[1].is_close(
            design3d.Point3D(0.5773502532353942, 1.2844570583532893, -0.12975650401980598)) or
    ...
    def test_minimum_distance_points_line(self):
        lineseg = edges.LineSegment3D(design3d.Point3D(0, 1.5, -1), design3d.Point3D(0, -.3, 0.5))
    ...
    def test_linesegment_intersections(self):
        ...
        lineseg3 = edges.LineSegment3D(design3d.Point3D(-1, -1, -1),
                                       design3d.Point3D(-math.sqrt(2) / 2, -math.sqrt(2) / 2, 0))
        ...
        self.assertEqual(arc3d_lineseg_inters[0],
                         design3d.Point3D(-0.5773502691896256, -0.5773502691896257, -0.5773502691896257))
    ...
    def test_minimum_distance_bspline(self):
        arc = edges.Arc3D.from_3_points(design3d.Point3D(-3, -3, 0),
                                        design3d.Point3D(6.324555320336761, -5.692099788303083, -0.8973665961010275),
                                        design3d.Point3D(3, 3, 2))
        bspline = edges.BSplineCurve3D.from_points_interpolation(
            [design3d.Point3D(1.2067665579541171, -1.246879774203074, -0.4359328108960321),
             design3d.Point3D(-1.2905737351068276, -5.961765089244547, -0.9872550297481824),
             design3d.Point3D(2.739350840642852, -5.869347626045908, -0.7880999427201254)], 2, centripetal=True)
        ...
        self.assertTrue(min_dist_point1.is_close(
            design3d.Point3D(-1.29057373513423, -5.961765089185557, -0.9872550297440593)))
        self.assertTrue(min_dist_point2.is_close(
            design3d.Point3D(-1.2905737351257018, -5.9617650891813065, -0.9872550297271026)))
