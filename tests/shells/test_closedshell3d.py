...
class TestClosedShell3D(unittest.TestCase):
    def test_union_adjacent_blocks(self):
        ...
        contour = design3d.wires.ClosedPolygon2D(
            [
        ...
        extrude1 = design3d.primitives3d.ExtrudedProfile(design3d.OXYZ, contour, [], -1)
        ...
        extruded_prifile1 = primitives3d.ExtrudedProfile(
            design3d.OYZX, wires.Contour2D(contour_primitives), [], 0.01, (0.4, 0.1, 0.1), 0.6
        )
        ...
        boundary1 = primitives3d.Block(
            design3d.Frame3D(design3d.O3D, design3d.X3D, 0.3 * design3d.Y3D, 0.1 * design3d.Z3D)
        )
    ...
    def test_set_operations_blocks(self):
        box_red = primitives3d.Block(
            design3d.Frame3D(
                ...
                design3d.Vector3D(0.4, 0, 0),
                design3d.Vector3D(0, 0.4, 0),
                design3d.Vector3D(0, 0, 0.4),
            ),
            color=(0.2, 1, 0.4),
            alpha=0.6,
        )
        box_green = box_red.frame_mapping(
            design3d.Frame3D(
                design3d.Point3D(-0.4, 0, -0.1),
                design3d.Vector3D(1, 0, 0),
                design3d.Vector3D(0, 1, 0),
                design3d.Vector3D(0, 0, 1),
            ),
            "new",
        )
        ...
        box_blue = primitives3d.Block(
            design3d.Frame3D(
                design3d.Point3D(0.1, 0, 0),
                design3d.Vector3D(0.2, 0, 0),
                design3d.Vector3D(0, 0.1, 0),
                design3d.Vector3D(0, 0, 1),
            ),
            alpha=0.6,
        )
        box_blue2 = box_blue.frame_mapping(
            design3d.Frame3D(
                design3d.Point3D(0.2, 0, 0),
                design3d.Vector3D(1, 0, 0),
                design3d.Vector3D(0, 1.8, 0),
                design3d.Vector3D(0, 0, 1),
            ),
            "old",
        )
    ...
    def test_union_two_disjoint_objects(self):
        poly1_vol1 = wires.ClosedPolygon3D(
            [
                design3d.Point3D(-0.1, -0.05, 0),
        ...
        shell_faces = [
            faces.Triangle3D(*points) for points in poly1_vol1.sewing(poly2_vol1, design3d.X3D, design3d.Y3D)
        ] + [faces.Triangle3D(*points) for points in poly2_vol1.sewing(poly3_vol1, design3d.X3D, design3d.Y3D)]
    ...
    def test_intersection(self):
        box1 = primitives3d.Block(
            design3d.Frame3D(
                design3d.Point3D(0, 0, 0),
                design3d.Vector3D(0.6, 0, 0),
                design3d.Vector3D(0, 0.6, 0),
                design3d.Vector3D(0, 0, 0.6),
            ),
            color=(1, 0.2, 0.2),
            alpha=0.6,
        )
        box2 = primitives3d.Block(
            design3d.Frame3D(
                design3d.Point3D(0, 0, 0),
                design3d.Vector3D(0.3, 0, 0),
                design3d.Vector3D(0, 0.3, 0),
                design3d.Vector3D(0, 0, 0.3),
            ),
            color=(0.1, 0.2, 1),
            alpha=0.6,
        )
        ...
        expected_box = primitives3d.Block(
            design3d.Frame3D(
                design3d.Point3D(0.15 * 3 / 2, 0, 0),
                design3d.Vector3D(0.15, 0, 0),
                design3d.Vector3D(0, 0.3, 0),
                design3d.Vector3D(0, 0, 0.3),
            ),
            color=(0.1, 0.2, 1),
    ...
    def test_point_belongs(self):
        closed_shell = SerializableObject.from_json(
            os.path.join(folder, "test_closed_shell_point_belongs2.json")
        ).primitives[0]
        points = [
            design3d.Point3D(-0.2, -0.6, 0.08),
            design3d.Point3D(-0.340920128805, -0.418071198223, 0.007036661148),
    ...
    def test_minimum_distance(self):
        closed_shell = SerializableObject.from_json(os.path.join(folder, "test_shells_distance2.json"))
        ...
        frame = design3d.Frame3D(
            design3d.Point3D(-0.01661984584195119, -0.04221251977732219, -0.04351622102493058),
            u_vector,
            v_vector,
            w_vector,
        )
        ...
        frame = design3d.Frame3D(
            design3d.Point3D(0.011516851705803667, 0.012859651289434018, 0.015147046170848444),
            u_vector,
            v_vector,
            w_vector,
        )
    ...
    def test_volume(self):
        closed_shell = SerializableObject.from_json(os.path.join(folder, "test_shell_volume.json"))
