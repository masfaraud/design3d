...
class TestExtrusionFace3D(unittest.TestCase):
    face = faces.ExtrusionFace3D.from_json(os.path.join(folder, "extrusionface_with_ellipse_test_boundingbox.json"))
    ...
    def test_from_contours3d(self):
        surface = surfaces.ExtrusionSurface3D.from_json(os.path.join(folder, "extrusionsurface_inner_contour.json"))
        contour_0 = wires.Contour3D.from_json(os.path.join(folder, "extrusionsurface_inner_contour_contour_0.json"))
        contour_1 = wires.Contour3D.from_json(os.path.join(folder, "extrusionsurface_inner_contour_contour_1.json"))
        ...
        contour_0 = wires.Contour3D.from_json(os.path.join(folder, "extrusionsurface_fullarcellipse_contour.json"))
