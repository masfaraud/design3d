...
class TestBoundingBox(unittest.TestCase):
    ...
    def test_center(self):
        self.assertEqual(self.bbox1.center, design3d.Point3D(1.0, 1.0, 1.0))
        self.assertEqual(self.bbox2.center, design3d.Point3D(2.0, 2.5, 0.0))
    ...
    def test_points(self):
        self.assertListEqual(
            ...
            [
                ...
                design3d.Point3D(2, 0, 0),
                design3d.Point3D(2, 2, 0),
                design3d.Point3D(0, 2, 0),
                design3d.Point3D(0, 0, 2),
                design3d.Point3D(2, 0, 2),
                design3d.Point3D(2, 2, 2),
                design3d.Point3D(0, 2, 2),
            ],
        )
    ...
    def test_from_points(self):
        self.assertEqual(
            BoundingBox.from_points(
                [
                    design3d.Point3D(4.0, 4.0, 4.0),
                    design3d.Point3D(4.1, 4.0, 4.0),
                    design3d.Point3D(4.0, 4.5, 4.0),
                    design3d.Point3D(4.0, 5.0, 4.9),
                    design3d.Point3D(5.0, 5.0, 5.0),
                ]
            ),
            self.bbox3,
        )
    ...
    def test_to_frame(self):
        ...
        self.assertEqual(frame.u, design3d.Vector3D(2.0, 0.0, 0.0))
        self.assertEqual(frame.v, design3d.Vector3D(0.0, 2.0, 0.0))
        self.assertEqual(frame.w, design3d.Vector3D(0.0, 0.0, 2.0))
        self.assertEqual(frame.origin, design3d.Point3D(1.0, 1.0, 1.0))
    ...
    def test_point_belongs(self):
        self.assertTrue(self.bbox1.point_inside(design3d.Point3D(1.0, 1.0, 1.0)))
        self.assertTrue(self.bbox1.point_inside(design3d.Point3D(1.0, 1.0, 0.0)))
        self.assertFalse(self.bbox1.point_inside(design3d.Point3D(3.0, 3.0, 3.0)))

    def test_distance_to_point(self):
        p0 = design3d.O3D
        self.assertEqual(self.bbox1.distance_to_point(p0), 0.0)
        p1 = design3d.Point3D(-1.0, -1.0, -1.0)
        self.assertEqual(self.bbox1.distance_to_point(p1), 3**0.5)
        p2 = design3d.Point3D(3.0, 3.0, 3.0)
        self.assertEqual(self.bbox1.distance_to_point(p2), 3**0.5)
        p3 = design3d.Point3D(1.0, 1.0, 1.0)
    ...
    def test_is_intersecting_triangle(self):
        ...
        triangle1 = Triangle3D(design3d.Point3D(5, -3, 0.5), design3d.Point3D(-3, 5, 0.5), design3d.Point3D(5, 5, 0.5))
        ...
        triangle7 = Triangle3D(design3d.Point3D(3, 3, 2), design3d.Point3D(4, 3, 2), design3d.Point3D(3, 4, 2))
        ...
        triangle8 = Triangle3D(design3d.Point3D(2, 2, 2), design3d.Point3D(3, 3, 3), design3d.Point3D(2, 3, 3))
