...
class TestRevolutionSurface3D(unittest.TestCase):
    ...
    def arc3d_to_2d(self):
        ...
        contour = d3dw.Contour3D.from_json(os.path.join(folder, "revolution_contour_bug_0.json"))
        ...
        contour = d3dw.Contour3D.from_json(os.path.join(folder, "revolution_contour_bug_1.json"))
        arc = contour.primitives[3]
        linesegment2d = surface.arc3d_to_2d(arc)[0]
    ...
    def test_contour3d_to_2d(self):
        ...
        contour = d3dw.Contour3D.from_json(os.path.join(folder, "revolutionface_contour.json"))
        ...
        contour = d3dw.Contour3D.from_json(os.path.join(folder, "revolutionface_contour_1.json"))
        contour2d = surface.contour3d_to_2d(contour)
        self.assertTrue(contour2d.is_ordered())

        surface = surfaces.RevolutionSurface3D.from_json(os.path.join(folder, "revolutionface_surface_2.json"))
        contour = d3dw.Contour3D.from_json(os.path.join(folder, "revolutionface_contour_2.json"))
        contour2d = surface.contour3d_to_2d(contour)
        self.assertTrue(contour2d.is_ordered())
    ...
    def test_arc3d_to_2d(self):
        ...
        arc3d = d3de.Arc3D.from_json(os.path.join(folder, "arc3d_to_2d_arc3d.json"))
        ...
        arc3d = d3de.Arc3D.from_json(os.path.join(folder, "arc3d_to_2d_arc3d_2.json"))
        brep = surface.arc3d_to_2d(arc3d)[0]
