...
class TestToroidalSurface3D(unittest.TestCase):
    ...
    def test_arc3d_to_2d(self):
        arc1 = edges.Arc3D.from_3_points(design3d.Point3D(1 - 0.1 / math.sqrt(2), 0, 0.1 / math.sqrt(2)),
        ...
        arc2 = edges.Arc3D.from_3_points(design3d.Point3D(-0.169132244445, 0.06508125180570001, 0.627719515715),
    ...
    def test_bsplinecurve3d_to_2d(self):
        control_points = [design3d.Point3D(-0.006429000000000001, 0.000765110438227, -0.0002349369830163),
    ...
    def test_point_projection(self):
        test_points = [design3d.Point3D(-2.0, -2.0, 0.0), design3d.Point3D(0.0, -2.0, 0.0),
                       design3d.Point3D(2.0, -2.0, 0.0),
                       design3d.Point3D(2.0, 0.0, 0.0), design3d.Point3D(2.0, 2.0, 0.0), design3d.Point3D(0.0, 2.0, 0.0),
                       design3d.Point3D(-2.0, 2.0, 0.0), design3d.Point3D(-2.0, 0.0, 0.0),
                       ]

        expected_points = [design3d.Point3D(-0.55 * math.sqrt(2), -0.55 * math.sqrt(2), 0.0),
    ...
    def test_line_intersections(self):
        expected_results = [[design3d.Point3D(2.9993479584651066, 0.031270376297965426, 0.031270376297965426),
        ...
        expected_results = [[design3d.Point3D(-1.0385780861224632, -2.73372290825405, -0.3815197706145943),
    ...
    def test_plane_intersections(self):
        ...
        # Test 2
        plane2 = surfaces.Plane3D(design3d.Frame3D(design3d.Point3D(0, 0, 0.5), design3d.X3D,
                                                  design3d.Y3D, design3d.Z3D))
        ...
        plane6 = surfaces.Plane3D(
            design3d.Frame3D(origin=design3d.Point3D(2.265348976860137, 1.0, 1.2653489768601376),
    ...
    def test_circle_intersections(self):
        toroidal_surface = surfaces.ToroidalSurface3D(design3d.OXYZ, 2, 1)
        circle = curves.Circle3D(design3d.Frame3D(origin=design3d.Point3D(1.0, 1.0, -0.8947368421052632),
                                                 u=design3d.Vector3D(1.0, 0.0, 0.0),
                                                 v=design3d.Vector3D(0.0, 1.0, 0.0),
                                                 w=design3d.Vector3D(0.0, 0.0, 1.0)), 1)
        ...
        self.assertTrue(circle_intersections[0].is_close(design3d.Point3D(2.0000006438528177, -0.5135128860482583, -0.9978935668376178)))
        self.assertTrue(circle_intersections[1].is_close(design3d.Point3D(2.0000002080103414, -0.5135127741429286, 0.9978935960903826)))

    def test_ellipse_intersections(self):
        toroidal_surface = surfaces.ToroidalSurface3D(design3d.Frame3D(origin=design3d.Point3D(1.0, 1.0, 0.0),
                                                                      u=design3d.Vector3D(-5.551115123125783e-17, 0.0,
                                                                                         0.9999999999999998),
                                                                      v=design3d.Vector3D(0.0, 0.9999999999999998, 0.0),
                                                                      w=design3d.Vector3D(-0.9999999999999998, 0.0,
                                                                                         -5.551115123125783e-17)), 3,
                                                      1)

        frame = design3d.Frame3D(origin=design3d.Point3D(0.0, 0.0, 0.0),
    ...
    def test_toroidal_surfaces(self):
        ...
        toroidal_surface1_1 = surfaces.ToroidalSurface3D(design3d.OXYZ, 1, .5)
        toroidal_surface2_1 = surfaces.ToroidalSurface3D(design3d.OXYZ, 0.8, .5)
        ...
        toroidal_surface1 = surfaces.ToroidalSurface3D(design3d.OXYZ, 1, .5)
        toroidal_surface2 = surfaces.ToroidalSurface3D(design3d.OXYZ, 1, .3)
