...
class TestLine3D(unittest.TestCase):
    ...
    def test_sort_points_along_line(self):
        ...
        list_points_3d = [
            ...
            design3d.Point3D(5, 10, 15),
            design3d.Point3D(-1, -2, -3),
            design3d.Point3D(2, 4, 6),
        ]
    ...
    def test_point_at_abscissa(self):
        line3d = curves.Line3D(
            design3d.Point3D(-0.16532959009, 0.669230747399, 0.6255868826019999),
            design3d.Point3D(-0.1653592907723126, 0.6687168836734351, 0.6247295250680509),
        )

        abscissa1 = -0.00019339887669772427
        self.assertTrue(
            line3d.point_at_abscissa(abscissa1).is_close(
        ...
        self.assertTrue(
            line3d.point_at_abscissa(abscissa2).is_close(
