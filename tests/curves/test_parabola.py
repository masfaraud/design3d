...
class TestParabola2D(unittest.TestCase):
    def test_line_intersections(self):
        expected_results = [
            [
                [
                    design3d.Point2D(0.43439728232830777, 4.150547925156083),
                    design3d.Point2D(-1407.1677289150666, 1283.7888444682421),
                ],
                [design3d.Point2D(0.0, 0.0), design3d.Point2D(-1.2570787221094177, -0.6285393610547088)],
                [
...
class TestParabola3D(unittest.TestCase):
    def test_line_intersections(self):
        expected_results = [
            [
                [
                    design3d.Point3D(2.77966655993497, 0.8078693778774468, 0.8078693778774468),
        ...
        for i, parabola in enumerate([parabola1, parabola2]):
            ...
            line3d_4 = curves.Line3D(design3d.Point3D(-2.0, -1.5, 1.5), design3d.Point3D(1.0, 1.5, -1.5))
    ...
    def test_trim(self):
        parabola = curves.Parabola3D(
            design3d.Frame3D(
                design3d.Point3D(-0.43301270189243873, 0.0, 0.7500000000003803),
                design3d.Vector3D(-0.0, 1.0, 0.0),
                design3d.Vector3D(0.5000000000002298, 0.0, 0.8660254037843059),
                design3d.Vector3D(0.8660254037844387, 0.0, -0.49999999999999994),
            ),
            0.21650635094600354,
        )
    ...
    def test_tangent(self):
        ...
        self.assertTrue(
            tangent_vector1.is_close(design3d.Vector3D(1.2108389957713368, 0.2606059058983855, 0.2606059058983855))
        )
        self.assertTrue(
            tangent_vector2.is_close(design3d.Vector3D(-1.1823406379820662, 1.4571957227751613, 1.4571957227751613))
        )
