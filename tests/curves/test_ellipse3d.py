...
class TestEllipse3D(unittest.TestCase):
    ellipse = curves.Ellipse3D(4, 3, design3d.Frame3D(design3d.O3D, design3d.X3D,
                                                     design3d.Z3D.cross(design3d.X3D), design3d.Z3D))
    ...
    def test_point_belongs(self):
        point_on_ellipse = design3d.Point3D(2.8284271247461903, 2.1213203435596424, 0)
        point_on_ellipse2 = design3d.Point3D(4, 0, 0)
        point_not_on_ellipse = design3d.Point3D(3, 3, 0)
    ...
    def test_discretization_points(self):
        ...
        expected_points = [design3d.Point3D(4.0, 0.0, 0.0), design3d.Point3D(0, 3, 0), design3d.Point3D(-4, 0, 0),
                           design3d.Point3D(0, -3, 0), design3d.Point3D(4.0, 0.0, 0.0)
                           ]
    ...
    def test_to_2d(self):
        ...
        self.assertEqual(design3d.O2D, ellipse_2d.center)
        self.assertEqual(design3d.X2D, ellipse_2d.major_dir)
    ...
    def test_abscissa(self):
        ...
        point3d = design3d.Point3D(-0.236335934849, -1.104105421298, -1.104105421298)
    ...
    def test_point_at_abcissa(self):
        ...
        self.assertTrue(point_at_abscissa.is_close(
            design3d.Point3D(-0.236343248911, -1.104108201699, -1.104108201699)))

    def test_trim(self):
        trim = self.ellipse3d.trim(design3d.Point3D(-0.12975651199692162, 0.9309036597828997, 0.9309036597828997),
                                   design3d.Point3D(0.12975651199692095, -0.9309036597829001, -0.9309036597829001))
        self.assertAlmostEqual(trim.length(), 4.844224110273849)
        self.assertTrue(trim.point_belongs(design3d.Point3D(1.386280848895, 0.495371104295, 0.495371104295)))

    def test_rotation(self):
        rotated_ellipse3d = self.ellipse3d.rotation(design3d.O3D, self.ellipse3d.frame.v, math.pi / 2)
        rotated_ellipse3d_points = rotated_ellipse3d.discretization_points(number_points=7)
        expected_points = [design3d.Point3D(-3.825416359218455e-16, -1.414213562373095, 1.4142135623730954),
                           design3d.Point3D(0.7071067811865475, -1.0606601717798207, 0.3535533905932728),
                           design3d.Point3D(0.7071067811865474, 0.3535533905932742, -1.060660171779822),
                           design3d.Point3D(2.825496434870558e-16, 1.414213562373095, -1.4142135623730954),
                           design3d.Point3D(-0.7071067811865472, 1.0606601717798212, -0.3535533905932735),
                           design3d.Point3D(-0.7071067811865475, -0.35355339059327356, 1.0606601717798214),
                           design3d.Point3D(-3.825416359218455e-16, -1.414213562373095, 1.4142135623730954)]
    ...
    def test_traslation(self):
        ...
        expected_points = [design3d.Point3D(1.1547005383792517, 1.8618073195657994, 0.4475937571927041),
                           design3d.Point3D(1.2844570503761727, 0.9309036597828986, -0.48330990259019657),
                           design3d.Point3D(0.12975651199692095, -0.2237968785963525, -1.6380104409694478),
                           design3d.Point3D(-1.1547005383792517, -0.44759375719270406, -1.8618073195657994),
                           design3d.Point3D(-1.2844570503761734, 0.48330990259019585, -0.9309036597828992),
                           design3d.Point3D(-0.12975651199692162, 1.6380104409694474, 0.22379687859635217),
                           design3d.Point3D(1.1547005383792517, 1.8618073195657994, 0.4475937571927041)]
    ...
    def test_frame_mapping(self):
        ...
        expected_points = [design3d.Point3D(2, 0.0, 0.0),
                           design3d.Point3D(1, 0.8660254037844388, 0.0),
                           design3d.Point3D(-1.0, 0.8660254037844382, 0.0),
                           design3d.Point3D(-2, -1.224646799147353e-16, 0.0),
                           design3d.Point3D(-1, -0.8660254037844386, 0.0),
                           design3d.Point3D(1.0, -0.8660254037844384, 0.0),
                           design3d.Point3D(2, 0.0, 0.0)]
        for point, expected_point in zip(frame_mapped_ellipse3d_points, expected_points):
            self.assertTrue(point.is_close(expected_point))

    def test_from_step(self):
        arguments = ["''", 85, '5.', '3.']
        object_dict = {85: design3d.OXYZ}
        ellipse = curves.Ellipse3D.from_step(arguments, object_dict)
        self.assertEqual(ellipse.major_dir, design3d.X3D)
        self.assertEqual(ellipse.normal, design3d.Z3D)
        self.assertEqual(ellipse.major_axis, 5.0)
        self.assertEqual(ellipse.minor_axis, 3.0)

    def test_linesegment_intersections(self):
        line1 = edges.LineSegment3D(design3d.Point3D(2.548547388496604, 3.4145727922810423, 3.4145727922810423),
                                    design3d.Point3D(-1.6329931618554527, -3.36504396942433, -3.36504396942433))
        line2 = edges.LineSegment3D(design3d.Point3D(-0.5978657793452512, -2.7629292888063484, -1.2103434310450787),
                                    design3d.Point3D(0.47829262347620083, 2.2103434310450787, -0.8948282844774607))
        line3 = edges.LineSegment3D(design3d.Point3D(3.0, 4.0, 2.5),
                                    design3d.Point3D(-3.0, -5.0, -2.0))
        lists_expected_intersections = [[design3d.Point3D(-0.23914631173810008, -1.105171715522539, -1.105171715522539),
    ...
    def test_ellipse_intersections(self):
        ...
        expected_results = [design3d.Point3D(1.387122270021, 0.498764319098, 0.498764319098),

                            design3d.Point3D(0.442026341769, -0.728884874076, -0.728884874076),

                            design3d.Point3D(-1.352092241872, -0.382919522276, -0.382919522276),

                            design3d.Point3D(-0.499996156401, 0.685417254467, 0.685417254467)]
