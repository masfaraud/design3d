...
class TestEllipse3D(unittest.TestCase):
    ellipse = curves.Ellipse3D(
        4, 3, design3d.Frame3D(design3d.O3D, design3d.X3D, design3d.Z3D.cross(design3d.X3D), design3d.Z3D)
    )
    ...
    def test_discretization_points(self):
        ...
        expected_points = [
            design3d.Point3D(4.0, 0.0, 0.0),
            design3d.Point3D(0, 3, 0),
            design3d.Point3D(-4, 0, 0),
            design3d.Point3D(0, -3, 0),
            design3d.Point3D(4.0, 0.0, 0.0),
        ]
    ...
    def test_point_at_abcissa(self):
        ...
        self.assertTrue(point_at_abscissa.is_close(design3d.Point3D(-0.236343248911, -1.104108201699, -1.104108201699)))

    def test_trim(self):
        trim = self.ellipse3d.trim(
            design3d.Point3D(-0.12975651199692162, 0.9309036597828997, 0.9309036597828997),
    ...
    def test_linesegment_intersections(self):
        ...
        line3 = edges.LineSegment3D(design3d.Point3D(3.0, 4.0, 2.5), design3d.Point3D(-3.0, -5.0, -2.0))
        lists_expected_intersections = [
            [
    ...
    def test_ellipse_intersections(self):
        ...
        expected_results = [
            design3d.Point3D(1.387122270021, 0.498764319098, 0.498764319098),
