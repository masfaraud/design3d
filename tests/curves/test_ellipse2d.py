...
class TestEllipse2D(unittest.TestCase):
    ...
    def test_line_intersections(self):
        ...
        self.assertTrue(intersections[1].is_close(design3d.Point2D(0.24999999999999978, -0.39386314307517367)))
    ...
    def test_discretization_points(self):
        self.assertTrue(self.discretized_points[0].is_close(design3d.Point2D(2.8284271247461903, 2.82842712474619)))
        self.assertTrue(self.discretized_points[5].is_close(design3d.Point2D(-2.8284271247461903, -2.82842712474619)))
        self.assertTrue(self.discretized_points[-2].is_close(design3d.Point2D(3.119499486825644, 1.4569917357158295)))

    def test_point_belongs(self):
        self.assertTrue(self.ellipse2d.point_belongs(self.discretized_points[3]))
        self.assertFalse(self.ellipse2d.point_belongs(design3d.Point2D(2, 2)))

    def test_point_inside(self):
        ellipse2d = curves.Ellipse2D(2, 1, design3d.Frame2D(design3d.O2D, design3d.X2D, -design3d.Y2D))

        point2d = design3d.Point2D(1.6, 0.7)
        self.assertFalse(ellipse2d.point_inside(point2d))
        point2d = design3d.Point2D(1.6, 0.5)
