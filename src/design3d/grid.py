...
class Grid2D:
    ...
    def __init__(self, lists_points: List[List[design3d.Point2D]], direction: List[str], name: str = ""):
    ...
    @classmethod
    def from_properties(cls, x_limits, y_limits, points_nbr, direction=None, name: str = ""):
        """
        ...
        for i in range(0, length_1 - 1):
            for j in range(0, length_2 - 1):
                quadrilateral_polygons.append(
                    design3d.wires.ClosedPolygon2D(
                        [
